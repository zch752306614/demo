...
import com.alice.novel.module.common.mapper.NovelInfoDao;
 ...
 */
@Service
public class NovelInfoServiceImpl extends ServiceImpl<NovelInfoDao, NovelInfo> implements NovelInfoService {
